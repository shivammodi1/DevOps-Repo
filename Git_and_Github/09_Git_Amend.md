# Git Amend Command
- It used for modifying the most recent commit.
- It allows you to change the commit message or add new changes to the last commit.
- `git commit --amend -m "New commit message"`: Modify the most recent commit message.
